...
<head>
    <title>Sector Leaders Registration</title>
...
<body>
    <div class="container text-center">
        <h1>Sector Leaders Registration</h1>
        ...
        <div class="row">
            <div class="col-10 col-md-6 mx-auto">
                <!-- Registration Form -->
                <form method="post" action="register-sector.php">
                    ...
                    <button type="submit" name="submit" class="btn btn-primary">Register Sector Leader</button>
                </form>
            </div>
        </div>
        ...
        <h2>Registered Sector Leaders</h2>
        <div class="row">
