...
<head>
    <title>Mayor Registration</title>
...
<body>
    <div class="container text-center">
        <h1>District Mayor Registration</h1>
        ...
        <div class="row">
            <div class="col-10 col-md-6 mx-auto">
                <!-- Registration Form -->
                <form method="post" action="register-district.php">
                    ...
                    <button type="submit" name="submit" class="btn btn-primary">Register Mayor</button>
                </form>
            </div>
        </div>
        ...
        <h2>Registered District Mayors</h2>
        <div class="row">
